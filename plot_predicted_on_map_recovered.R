...
pred.data <- read.csv("id.predclass.csv")
...
for(watershed_number in 34:359){
...
try(writeOGR(watershed_traverses, dsn= "B:/Remap", driver = "ESRI Shapefile", layer = paste0("pred",watershed_number)))
}
